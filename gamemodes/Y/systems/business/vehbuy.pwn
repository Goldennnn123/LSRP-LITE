...
new g_aDealershipData[][VehiclePriceID] =
{
    ...
    ///// 4 Door:
    {"Admiral",445, 3, 68000},//24
    {"Elegant",507, 3, 79000},//25
    {"Emperor",585, 3, 80000},//26
    {"Glendale",466, 3,75000},//27
    {"Greenwood",492, 3,75000},//28
    {"Intruder",546, 3,54600},//29
    {"Intruder",546, 3,54600},//30
    {"Merit",551, 3,78000},//31
    {"Nebula",516, 3,60000},//32
    {"Oceanic",467, 3,89000},//33
    {"Premier",426, 3,89000},//34
    {"Primo",547, 3,90000},//35
    {"Sentinel",405, 3,79000},//36
    {"Stafford",580, 3,80000},//37
    {"Stretch",409, 3,1000000},//38
    {"Sunrise",550, 3,69000},//39
    {"Tahoma",566, 3,99000},//40
    {"Vincent",540, 3,78000},//41
    {"Washington",421, 3,90000},//42
    {"Willard",529, 3,89000},//43
    ///// 4 Door:

    ///// service:
    {"Bus",431, 4,350000},//44
    {"Cabbie",438, 4,100000},//45
    {"Coach",437, 4,360000},//46
    {"Taxi",420, 4,120000},//47
    {"Towtruck",525, 4,35000},//48
    ///// service:

    ///// Utility:
    {"Benson",499, 5,89000},//49
    {"Boxville Mission",609, 5,89000},//50
    {"Boxville Mission",498, 5,89000},//51
    {"Boxville",498, 5,89000},//52
    {"Hotdog",588, 5,99000},//53
    {"Linerunner",403, 5,1200000},//54
    {"Mule",414, 5,89000},//55
    {"Roadtrain",515, 5,1200000},//56
    {"Tanker",514, 5,1200000},//57
    {"Tractor",431, 5,600000},//58
    {"Yankee",456, 5,89000},//59
    {"Dune",573, 5,120000},//60
    ///// Utility:

    ///// Vans:
    {"Berkley's RC Van",459, 6,66000},//61
    {"Bobcat",422, 6,55000},//62
    {"Burrito",482, 6,55000},//63
    {"Moonbeam",418, 6,99000},//64
    {"News Van",582, 6,150000},//65
    {"Pony",582, 6,66000},//66
    {"Rumpo",440, 6,66000},//67
    {"Sadler",543, 6,80000},//68
    {"Walton",478, 6,78000},//69
    {"Yosemite",554, 6,99000},//70
    ///// Vans:

    ///// SUVs:
    {"Huntley",579, 7,120000},//71
    {"Landstalker",400, 7,790000},//72
    {"Perennial",404, 7,99000},//73
    {"Rancher",489, 7,99000},//74
    {"Rancher",505, 7,99000},//75
    {"Regina",479, 7,99000},//76
    {"Romero",442, 7,120000},//77
    {"Solair",458, 7,130000},//78
    ///// SUVs:

    ///// Lowriders:
    {"Blade",536, 8,150000},//79
    {"Broadway",575, 8,150000},//80
    {"Remington",534, 8,160000},//81
    {"Savanna",567, 8,68000},//82
    {"Slamvan",535, 8,79000},//83
    {"Tornado",576, 8,79000},//84
    {"Voodoo",412, 8,130000},//85
    ///// Lowriders:
    ...
    {"Bullet",541, 10,400000},//91
    {"Cheetah",415, 10,450000},//92
    {"Comet",480, 10,490000},//93
    {"Elegy",562, 10,500000},//94
    {"Flash",565, 10,350000},//95
    {"Infernus",411, 10,460000},//96
    {"Jester",559, 10,500000},//97
    {"Stratum",561, 10,350000},//98
    {"Sultan",560, 10,780000},//99
    {"Uranus",558, 10,990000}//100
    /////Street racers:
...
hook OP_ClickPlayerTextDraw(playerid, PlayerText:playertextid)
{
    if(PlayerInfo[playerid][pGUI] == 2)
    {
        ...
        if(playertextid == VehicleBuyMenu[playerid][1])
        {
            if(PlayerbuyVeh[playerid][V_STEP] == 100)
            {
                PlayerbuyVeh[playerid][V_STEP] = 0;
